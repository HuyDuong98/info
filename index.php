...
<head>
    ...
    <link rel='stylesheet' type='text/css' media='screen' href='fonts/fontawesome-5.15.1/css/all.min.css'>
...
<body>
    <header>
        ...
        <nav class="navbar navbar-expand-lg navbar-light navbar-fixed-top navbar-expanded">
            <div class="container">
                <a class="navbar-brand" href="#">HuyDuong</a>
        ...
        <div class="banner-main">
            ...
            <div class="banner-content text-center text-white">
                <div class="container">
                    ...
                    <h1 class="text-uppercase">Dương Ngọc Huy</h1>
                    <div class="subtext">
                        <span id="demo">
                    </div>
                </div>
    ...
    <section class="section-space">
        <!-- <div class="position-relative" style="min-height:100vh"></div> -->
        <!-- <img class="ellipse-header" src="img/Ellipse 1.png" /> -->

        <div class="container">
            <div class="row">
                <div class="col-md-2"></div>
                <div class="section-title text-center col-md-8 mb-0">
                    <h4>About</h4>
                    <h1 class="title mb-50">Lorem Ipsum has standard</h1>
                </div>
            </div>
            <div class="row">
                <div class="col-md-2"></div>
                <div class="about-info col-md-8 mb-100">
                    <div class="media about-thumb media-middle">
                        <a href="#"><img class="media-object" src="img/IMG_UPLOAD_20180414_005302.jpg"></a>
                    </div>
                    <div class="content">
                ...
                <div class="about-info col-md-8">
                    <div class="row">
                        <div class="col-md-6 col-12">
                            <h4 class="text-uppercase font-weight-bold">Profile</h4>
    ...
    <section class="section-space parallax bg-01">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <h1 class="title text-white">Hello Word!</h1>
                </div>
            </div>
        </div>
    </section>
    <section class="section-space">
        <div class="container">
            <div class="section-title text-center">
                ...
                <h4>Lorem Ipsum has standard</h4>
            </div>
                ...
                <a href="#" class="timeline">
                    ...
                    <div class="timeline-content">
                        ...
                        <p class="description">
                            ...
                            Aperiam eveniet nam nostrum odit quasi ullam voluptatum.
                        </p>
                    </div>
                </a>
                <a href="#" class="timeline">
    ...
    <section class="section-space parallax bg-02">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <h1 class="title text-white">Hello Word!</h1>
                    ...
                    <div id="portfoliolist" class="animate-box">
                        ...
                        <div class="portfolio all logo" data-cat="logo">
                            <div class="portfolio-wrapper">
                                <img src="images/portfolio_02.jpg" alt="" />
                                <div class="label">
                        ...
                        <div class="portfolio all app web" data-cat="app">
                            <div class="portfolio-wrapper">
                                <img src="images/portfolio_03.jpg" alt="" />
                                <div class="label">
                                    <div class="label-text">
                        ...
                        <div class="portfolio all web icon" data-cat="web">
                            <div class="portfolio-wrapper">
                                <img src="images/portfolio_04.jpg" alt="" />
                                <div class="label">
                                    <div class="label-text">
                        ...
                        <div class="portfolio all app" data-cat="app">
                            <div class="portfolio-wrapper">
                                <img src="images/portfolio_05.jpg" alt="" />
                                <div class="label">
                                    <div class="label-text">
                        ...
                        <div class="portfolio all " data-cat="web">
                            <div class="portfolio-wrapper">
                                <img src="images/portfolio_06.jpg" alt="" />
                                <div class="label">
                                    <div class="label-text">
                                        <a class="text-title">Typography Company</a>
                                        <span class="text-category">Business card</span>
                        ...
                        <div class="portfolio all app" data-cat="app">
                            <div class="portfolio-wrapper">
                                <img src="images/portfolio_07.jpg" alt="" />
                                <div class="label">
                                    <div class="label-text">
                                        <a class="text-title">Typography Company</a>
                                        <span class="text-category">Business card</span>
    ...
    <script>
        ...
        typewriter.typeString('Tôi là Front-end Developer')
            .pauseFor(2500)
            .deleteAll()
            .typeString('Chúc bạn một ngày tuyệt vời!')
            .pauseFor(2500)
            .deleteAll()
            // .pauseFor(2500)
            // .deleteChars(7)
